    ...
    def POST(self):
        ...
        try:
            ...
            try:
                ...
                return json.dumps({"status": "success", "source": result}, ensure_ascii=False)
            finally:
                try:
                    os.remove(tmp_path)
                except OSError:
...
class KnowledgeSkillLinkHandler:
    def POST(self):
        ...
        try:
            ...
            if not skill_name:
                return json.dumps({"status": "error", "message": "skill_name is required"})
            if not source_paths:
                return json.dumps({"status": "error", "message": "source_paths is required"})
            svc = KnowledgeService(_get_workspace_root())
...
class KnowledgeOrganizeHandler:
    def POST(self):
        ...
        try:
            ...
            t.start()
            return json.dumps({"status": "started", "message": "整理已开始，请轮询状态"}, ensure_ascii=False)
        except Exception as e:
...
class KnowledgeKnowledgeGraphHandler:
    def GET(self):
        ...
        try:
            ...
            return json.dumps({"status": "error", "message": str(e), "nodes": [], "edges": []})
...
class TextbookHandler:
    def GET(self):
        ...
        try:
            ...
            return json.dumps({"status": "success", "textbooks": [t.to_dict() for t in textbooks]}, ensure_ascii=False)
        except Exception as e:
    ...
    def POST(self):
        ...
        try:
            ...
            return json.dumps({"status": "success", "textbook": result.to_dict()}, ensure_ascii=False)
        except Exception as e:
...
class TextbookDetailHandler:
    def GET(self, book_id):
        ...
        try:
            ...
            if config is None:
                return json.dumps({"status": "error", "message": "Textbook not found"})
            return json.dumps({"status": "success", "textbook": config.to_dict()}, ensure_ascii=False)
        except Exception as e:
...
class TextbookOutlineHandler:
    def GET(self, book_id):
        ...
        try:
            bridge = _get_textbook_bridge()
            outline = bridge.get_outline(book_id)
            return json.dumps({"status": "success", "outline": outline}, ensure_ascii=False)
        except Exception as e:
...
class TextbookChaptersHandler:
    def GET(self, book_id):
        ...
        try:
            ...
            return json.dumps({"status": "success", "chapters": chapters}, ensure_ascii=False)
        except Exception as e:
...
class TextbookChapterDetailHandler:
    def GET(self, book_id, num):
        ...
        try:
            ...
            return json.dumps({"status": "success", "chapter_num": int(num), "content": content}, ensure_ascii=False)
        except Exception as e:
...
class TextbookPipelineHandler:
    def GET(self, book_id):
        ...
        try:
            ...
            return json.dumps({"status": "success", "pipeline": status}, ensure_ascii=False)
        except Exception as e:
    ...
    def POST(self, book_id):
        ...
        try:
            ...
            if action == "pause":
                ...
                return json.dumps({"status": "success", "paused": result})
            elif action == "resume":
                result = bridge.resume_pipeline(book_id)
                return json.dumps({"status": "success", "resumed": result})
            elif action == "cancel":
                result = bridge.cancel_pipeline(book_id)
                return json.dumps({"status": "success", "cancelled": result})
            else:
            ...
            return json.dumps({"status": "error", "message": str(e) or repr(e) or "Unknown error"})
    ...
    def GET(self, book_id):
        ...
        try:
            ...
            if export_format != "word":
                return json.dumps({"status": "error", "message": "PDF export is not supported yet; please export Word first."}, ensure_ascii=False)
            ...
            if not output_path:
                return json.dumps({"status": "error", "message": "Export failed"})
            from urllib.parse import quote
            import os as _os
            file_url = f"/api/file?path={quote(output_path)}"
            filename = _os.path.basename(output_path)
            return json.dumps({"status": "success", "file_url": file_url, "file_path": output_path, "filename": filename}, ensure_ascii=False)
        except Exception as e:
...
class TextbookOutlineVersionHandler:
    def GET(self, book_id):
        ...
        try:
            ...
            return json.dumps({"status": "success", "versions": versions}, ensure_ascii=False)
        except Exception as e:
...
class TextbookOutlineVersionDetailHandler:
    def GET(self, book_id, version_id):
        ...
        try:
            ...
            return json.dumps({"status": "success", "version_id": version_id, "content": content}, ensure_ascii=False)
        except Exception as e:
...
class TextbookPreferencesHandler:
    def GET(self, book_id):
        ...
        try:
            ...
            return json.dumps({"status": "success", "preferences": preferences}, ensure_ascii=False)
        except Exception as e:
...
class ChatHistoryLoadHandler:
    def GET(self, session_id):
        ...
        try:
            ...
            return json.dumps({"status": "success", "messages": messages}, ensure_ascii=False)
        except Exception as e:
...
class ChatCancelHandler:
    def POST(self):
        ...
        try:
            ...
            return json.dumps({"status": "success", "message": "Chat cancelled"})
        except Exception as e:
