...
available_setting = {
    ...
    "agent_runtime_board_max_chars": 4000,
    "agent_runtime_board_max_events": 10,
    "realtime_memory_enabled": True,
    "realtime_process_memory_enabled": True,
    "realtime_session_memory_enabled": True,
    "realtime_process_state_files_enabled": False,
    "memory_candidate_auto_record_enabled": False,
    "memory_retention_enabled": True,
    "memory_startup_cleanup_enabled": True,
    "memory_startup_cleanup_interval_days": 7,
    "memory_startup_cleanup_drop_process_state_files": True,
    "memory_process_retention_days": 7,
    "memory_process_max_files": 60,
    "memory_session_retention_days": 14,
    "memory_session_max_files": 80,
    "memory_session_dedupe_window": 20,
    "memory_profile_recent_focus_limit": 10,
    "memory_profile_field_limit": 30,
    "memory_error_retention_days": 30,
    "memory_error_max_files": 80,
    "memory_retention_interval_hours": 24,
